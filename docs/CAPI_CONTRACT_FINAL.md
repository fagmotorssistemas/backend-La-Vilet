...
| Apertura de ficha de unidad               | ViewContent / detalle_unidad   | website                       | `view:{visitor_key}:{unit_id}` | unit_id y visitor_key                                                                            | Mismo event_name + event_id                           |
...
| Favorito guardado                         | AddToWishlist / favorito       | website                       | `wishlist:{lead_id}:{unit_id}` | lead_id y unit_id                                                                                | Mismo event_name + event_id                           |
...
| Venta real confirmada                     | Purchase / compra              | system_generated / CRM        | `purchase:{sale_id}`           | sale_id, lead_id, unit_id, value, currency, registered_at, sale_at                               | No se inventa evento web                              |
